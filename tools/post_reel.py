...
def main():
    ...
    ap.add_argument("--reel", help="which reel to build")
    ...
    print(f"rendering {name}: {spec['dur']:.1f}s, {total_frames} frames at {reel_render.FPS}fps")
