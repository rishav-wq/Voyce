...
function showError(msg) {
  ...
  if (msg === "LIMIT_REACHED") {
    el.innerHTML = `You've used all 7 free generations. To get more credits, email us at <a href="mailto:r65581350@gmail.com" style="color:#6c47ff;font-weight:700;">r65581350@gmail.com</a>.`;
  } else {
    el.textContent = msg;
  }
